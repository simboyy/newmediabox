...
describe('Review API:', function() {
  ...
  describe('PUT /api/reviews/:id', function() {
    ...
    it('should respond with the original review', function() {
      expect(updatedReview.name).to.equal('New Review');
      expect(updatedReview.info).to.equal('This is the brand new review!!!');
    });
    ...
    it('should respond with the updated review on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          expect(review.name).to.equal('Updated Review');
          expect(review.info).to.equal('This is the updated review!!!');
  ...
  describe('PATCH /api/reviews/:id', function() {
    ...
    it('should respond with the patched review', function() {
      expect(patchedReview.name).to.equal('Patched Review');
      expect(patchedReview.info).to.equal('This is the patched review!!!');
    });
  });
