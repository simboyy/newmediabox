...
var _brand = require('../api/brand/brand.model');

var _brand2 = _interopRequireDefault(_brand);

var _PaymentMethod = require('../api/PaymentMethod/PaymentMethod.model');
...
var _feature = require('../api/feature/feature.model');
...
var _shipping = require('../api/shipping/shipping.model');

var _shipping2 = _interopRequireDefault(_shipping);

var _country = require('../api/country/country.model');
...
_address2.default.find(function (err, data) {
  if (data.length < 1) {
    _address2.default.create({
      "__v": 0,
...
_shipping2.default.find(function (err, data) {
  if (data.length < 1) {
    _shipping2.default.create({
...
_coupon2.default.find(function (err, data) {
  if (data.length < 1) {
    _coupon2.default.create({
      "__v": 0,
...
_feature2.default.find(function (err, data) {
  if (data.length < 1) {
    _feature2.default.create({
      "key": "Type",
      "val": "Blouses",
      "active": true,
...
_setting2.default.find(function (err, data) {
  if (data.length < 1) {
...
_PaymentMethod2.default.find(function (err, data) {
  if (data.length < 1) {
    _PaymentMethod2.default.create({
      "name": "COD",
      "email": "-",
      "active": true,
...
_category2.default.find(function (err, data) {
  if (data.length < 1) {
    _category2.default.create({
      ...
      "active": true,
      "category": 2,
      "child": ["57c190f7993c5fe64d000004", "57c1907a993c5fe64d000002", "57c190df993c5fc13f000006", "57c198e2993c5fc13f00000f", "57c19208993c5fc13f00000c", "57c191b2993c5fc13f00000a", "57c19189993c5fc13f000009", "57c19150993c5fe64d000006", "57c1913a993c5fc13f000008", "57c1919a993c5fe64d000007", "57c191c5993c5fe64d000008", "57c191da993c5fc13f00000b", "57c191f2993c5fe64d000009", "57cebfcee804f70584e81d56"],
      "name": "Men",
      "parentCategory": 0,
      "slug": "men",
      "sub_categories": [],
      ...
      "active": true,
      "category": 1,
      "child": ["57c1910d993c5fc13f000007", "57c1923a993c5fc13f00000d", "57c1909e993c5fc13f000005", "57c19125993c5fe64d000005", "57c198ce993c5fe64d00000c", "57c198bb993c5fc13f00000e", "57c19938993c5fc13f000011", "57c198f5993c5fe64d00000d", "57c1924f993c5fe64d00000b", "57c19929993c5fe64d00000e"],
      "name": "Women",
      "parentCategory": 0,
      "slug": "women",
      "sub_categories": [],
...
_brand2.default.find(function (err, data) {
  if (data.length < 1) {
    _brand2.default.create({
