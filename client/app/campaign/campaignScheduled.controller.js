...
.controller('CampaignScheduledController', function ($scope, Cart ,Auth,$log, $mdSidenav,Campaign,$loading,Upload, $timeout, $http, socket, $mdDialog, Settings, Toast) {
...
`,
   ...
   // alert(Auth.getCurrentUser().email);
          ...
          vm.mainGridOptions = {
            ...
            columns: [
            { field: "campaignNo", title: "Campaign #" },
