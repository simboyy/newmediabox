...
class CartController {
  constructor(ToggleComponent, $filter ,Media ,Auth, Toast,Campaign ,Settings,Cart,SweetAlert, Category, Brand, Product, Inventory,$state, $stateParams,$mdMedia,$mdDialog) {
       var vm = this;
...
`,
    ...
    function querySearch (input,variant) {
         //console.log(input);
                       ...
                       var vm = this;
                         Campaign.save(newCampaign).$promise.then(function(res) {
                            ...
                            for (var i = 0; i < newCampaign.items.length; i++) {
                                ...
                                Media.update({ id:item.creative }, {pub:item.uid}).$promise.then(function(res) {
                                  }, function(error) { 
                                  // error handler
                                  // 
                                  console.log(error);
